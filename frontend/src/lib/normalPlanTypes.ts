...
export const HORIZON_GUIDE_CATEGORIES = [
  { value: 'calories', label: 'How to Calculate Nutrition', icon: 'Calculator' },
  { value: 'workouts', label: 'How to Structure Exercise', icon: 'Dumbbell' },
  { value: 'hydration', label: 'Daily Hydration', icon: 'Droplets' },
  { value: 'sleep', label: 'Better Sleep', icon: 'Moon' },
  { value: 'mindset', label: 'Mindset & Habit Mindset', icon: 'Brain' },
];
