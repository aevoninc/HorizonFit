...
const features = [
  {
    ...
    description:
      "Scientifically designed fitness journey with progressive zone training and personalized task allocation.",
  },
  {
    icon: Calendar,
    title: "Personal Consultations",
    description:
      "One-on-one sessions with certified fitness professionals to guide your transformation.",
  },
  {
    icon: Users,
    title: "Expert Guidance",
    description:
      "Our doctors create customized workout plans based on your fitness level and goals.",
  },
];
        ...
        <div className="container relative mx-auto px-4">
          ...
          >
            ...
            <p className="mx-auto mb-10 max-w-2xl text-lg text-muted-foreground md:text-xl">
              Join our revolutionary 15-week fitness program with personalized
              guidance from certified professionals. Your journey to a
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              Our proven 5-zone system progressively builds your fitness,
                ...
                <div className="card-elevated group p-6 text-center transition-all duration-300 hover:-translate-y-1">
                  <div
                    className={`mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full ${
                      index === 4 ? "gradient-phoenix" : "bg-secondary/20"
                    }`}
                  >
                    <span
            ...
            <div className="grid items-center md:grid-cols-2">
              <div className="p-12">
                ...
                <p className="mb-6 text-secondary-foreground/80">
                  ...
                  fitness coaching, Dr. Mitchell has helped thousands of clients
                  achieve their health goals through personalized programs.
                </p>
