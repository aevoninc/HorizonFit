...
import { Calendar, Dumbbell, Users, ArrowRight, CheckCircle, Flame, Heart, Award } from 'lucide-react';

const features = [
  {
    icon: Dumbbell,
    title: '15-Week Program',
    description: 'Scientifically designed fitness journey with progressive zone training and personalized task allocation.',
  },
  {
    icon: Calendar,
  ...
  },
  {
    ...
    description: 'Our doctors create customized workout plans based on your fitness level and goals.',
  },
];

const programSteps = [
  { zone: 1, title: 'Foundation', description: 'Build core strength and establish healthy habits' },
  { zone: 2, title: 'Progression', description: 'Increase intensity and expand your capabilities' },
  { zone: 3, title: 'Endurance', description: 'Push your limits and build lasting stamina' },
  { zone: 4, title: 'Mastery', description: 'Refine techniques and maximize performance' },
  { zone: 5, title: 'Excellence', description: 'Achieve peak fitness and maintain results' },
];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container relative mx-auto px-4">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-primary">Rise to Your Potential</span>
            </motion.div>

            <h1 className="mb-6 text-5xl font-extrabold leading-tight tracking-tight text-foreground md:text-6xl lg:text-7xl">
              Transform Your Body,{' '}
              <span className="text-gradient-phoenix">Elevate Your Life</span>
            </h1>

            <p className="mx-auto mb-10 max-w-2xl text-lg text-muted-foreground md:text-xl">
              Join our revolutionary 15-week fitness program with personalized guidance from certified professionals. Your journey to a healthier, stronger you starts here.
            </p>
      ...
      <section className="bg-muted/30 py-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="mb-4 text-4xl font-bold text-foreground">The 15-Week Journey</h2>
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              Our proven 5-zone system progressively builds your fitness, ensuring sustainable results.
            </p>
          </motion.div>
      ...
      <section className="bg-muted/30 py-20">
        <div className="container mx-auto px-4">
          ...
          >
            {[
              { icon: CheckCircle, text: 'Personalized Programs' },
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="mx-auto mb-8 max-w-xl text-primary-foreground/90">
              Join thousands of others who have already transformed their lives with HorizonFit.
            </p>
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link to="/enroll">
