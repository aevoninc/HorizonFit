...
const passwordResetOtpTemplate = (userName, otpCode) => {
    const title = 'Your Password Reset OTP';
    const content = `
        <p>Hello ${userName},</p>
        <p>Use the OTP below to reset your HorizonFit account password:</p>
        <div style="background-color: #f8f9fa; border: 1px dashed #007bff; padding: 15px; border-radius: 8px; margin: 20px 0; text-align: center;">
            <p style="margin: 0; font-size: 24px; font-weight: bold; letter-spacing: 6px; color: #007bff;">${otpCode}</p>
        </div>
        <p style="color: #dc3545; font-weight: bold;">This OTP is valid for 10 minutes.</p>
        <p>If you did not request this, please ignore this email.</p>
    `;

    return renderBaseTemplate(title, content, 'https://horizonfit.in/#/auth', 'Open HorizonFit');
};
